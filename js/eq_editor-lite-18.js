...
function EqTextArea(preview, input, comment, download, intro) {
    ...
    this.set = function (preview, input, comment, download, intro) {
        ...
        if (input == undefined || input == '') input = 'latex_formula'; //textarea_id
        ...
        console.log(preview);
        console.log(this.equation_preview);
        this.equation_input = EqEditor.$(input);
        console.log(input);
        console.log(this.equation_input);
        this.equation_comment = EqEditor.$(comment);
        console.log(comment);
        console.log(this.equation_comment);
        this.equation_download = EqEditor.$(download);
        console.log(download);
        console.log(this.equation_download);
    ...
    this.setText = function (val) {
        ...
        do {
            ...
            console.log(this.equation_input.value);
            this.textchanged();
            this.renderEqn();
        }
    };
        ...
        if (a.length > 0) 
            {
                ...
                console.log(EqEditor.getSize() + a);
            }
        return '';
    };
    ...
    this.setdownload = function (text) {
        if (this.equation_download){
            ...
            console.log(this.equation_download.innerHTML);
        } 
    ...
    this.setcomment = function (text) {
        if (this.equation_comment) {
            ...
            console.log(this.equation_comment.innerHTML);
        }
    };
...
var EqEditor = {
    ...
    Panel: {
        ...
        hover: function (img, e) {
            if (this.hoverdiv) {
                this.lock = true;
                //showing image when we hover the mouse on the toolbar......
                this.hoverdiv.innerHTML = '<img src="' + EQUATION_ENGINE + '/gif.latex?\\200dpi ' + img.latex + '"/>';
                console.log(EQUATION_ENGINE);
                if ('pageX' in e) {
